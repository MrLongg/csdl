                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-checkbox="true">
                                <?php
                                    $sql_em = "SELECT * FROM employee, charge where charge.orCode =  $or_Code and charge.opCode = employee.emCode";
                            ...
                            <td data-checkbox="true"><?php echo $row_order['address']; ?></td>
                            <?php  
                            }
                            ?>
                            <?php
                                $sql_cuPhone = "SELECT * FROM cuphonenumber WHERE cuphonenumber.cuCode =  $cu_Code ";
                                $query6 =  mysqli_query($conn, $sql_cuPhone);
                            ?>
                            <td data-checkbox="true">
                            <?php
                                while($row_cuPhone = mysqli_fetch_array($query6)){
                                    echo $row_cuPhone['cuPhone'];
                            ?>
                            <br>
                            <?php
                                }
                            ...
                            <?php
                                ...
                                $query7 =  mysqli_query($conn, $sql_em);
                                while($row_emp = mysqli_fetch_array($query7)){
                            ?>
                            <?php echo $row_emp['fname']?>
                            <?php echo $row_emp['lname']?>
                            <?php  
                            }
                            ?>
                            </td>
