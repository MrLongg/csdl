...
if(isset($_POST['capnhatdonhang'])){
	...
	$sql_update_donhang = mysqli_query($connn,"UPDATE tbl_donhang SET tinhtrang='$xuly' WHERE mahang='$mahang'");
	$sql_update_giaodich = mysqli_query($connn,"UPDATE tbl_giaodich SET tinhtrangdon='$xuly' WHERE magiaodich='$mahang'");
}
...
<?php
	...
	$sql_update_donhang = mysqli_query($conn,"UPDATE tbl_donhang SET huydon='$huydon' WHERE mahang='$magiaodich'");
	$sql_update_giaodich = mysqli_query($conn,"UPDATE tbl_giaodich SET huydon='$huydon' WHERE magiaodich='$magiaodich'");
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-5">
				...
				<?php
				$sql_select = mysqli_query($conn,"SELECT * FROM tbl_sanpham,tbl_khachhang,tbl_donhang WHERE tbl_donhang.sanpham_id=tbl_sanpham.sanpham_id AND tbl_donhang.khachhang_id=tbl_khachhang.khachhang_id GROUP BY mahang "); 
				?> 
				<table class="table table-bordered ">
					<tr>
						<th>Thứ tự</th>
